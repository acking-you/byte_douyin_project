...
func QueryFavorVideoList(userId int64) (*FavorVideoList, error) {
...
func (q *QueryFavorVideoListFlow) Do() (*FavorVideoList, error) {
...
func (q *QueryFavorVideoListFlow) packData() error {
	q.videoList = &FavorVideoList{Videos: q.videos}
	return nil
}
