...
func PostComment(userId int64, videoId int64, commentId int64, actionType int64, commentText string) (*CommentResponse, error) {
...
func (p *PostCommentFlow) Do() (*CommentResponse, error) {
	var err error
...
func (p *PostCommentFlow) packData() error {
	...
	p.CommentResponse = &CommentResponse{MyComment: p.comment}
